...
(function (window, undefined) {
   ...
   /**
     ...
     *
     */
    barcode: function(value, symbology, height) {
        var symbologies = {
            'upca': 0x00,
            'upce': 0x01,
            'ean13': 0x02,
     ...
     *
     */
    qrcode: function(value, model, size, errorlevel) {
     ...
     *
     */
    image: function(element, width, height, algorithm, threshold) {
        if (width % 8 !== 0) {
        ...
        var getPixel = (x, y) => image.data[((width * y) + x) * 4] > 0 ? 0 : 1;
